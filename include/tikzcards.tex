...
\pgfmathsetmacro{\cardwidth}{2.2225}
\pgfmathsetmacro{\cardradius}{\cardwidth/2}
\pgfmathsetmacro{\cardheight}{3.4925}
...
%   Kategorie der Karte
% The two bands that go along the left hand side,
% the uppermost of which has a symbol in it while
% the other has a county name in it
...
\newcommand{\cardtypeNorfolk}{\cardtype{norfolkbg}{Norfolk}{\hspace{-1mm}\Large\floweroneright}}
\newcommand{\cardtypeHertfordshire}{\cardtype{hertfordshirebg}{Hertfordshire}{\hspace{-1.4mm}\huge\ding{78}}}
\newcommand{\cardtypeCambridgeshire}{\cardtype{cambridgeshirebg}{Cambridgeshire}{\hspace{-1mm}\LARGE\ding{45}}}
\newcommand{\cardtypeEssex}{\cardtype{essexbg}{Essex}{\hspace{-1mm}\LARGE\lefthand}}
\newcommand{\cardtypeSuffolk}{\cardtype{suffolkbg}{Suffolk}{\hspace{-1mm}\LARGE\ding{48}}}
...
%   Inhalt der Karte
% All the text that would go in the white box at the bottom
% of the card
...
%   Preis der Karte
% Thing in the top right hand corner with a number in it
